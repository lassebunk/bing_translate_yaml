...
Run:
  ...
  $ rake translate from=en to=es client_id="<Your Microsoft API client ID>" client_secret="<Your Microsoft API client secret>"
...
Copyright (c) 2012 Lasse Bunk, Kelly Mahan, released under the MIT license
